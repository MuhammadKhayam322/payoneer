...
const footerSections: FooterSection[] = [
 ...
 
  {
    ...
    links: [
      ...
      { label: "Contact Us", href: "/investors", highlight: true },
  ...
  },
  {
    title: "Help",
    links: [
      { label: "FAQ", href: "/help/customer-care" },
      { label: "1237865", href: "/help/security" },
      {
        label: "brandraize1@gmail.com",
        ...
        >
         ...
         <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "12px", margin: 0 }}>
            © 2005-2026 Brandraize Inc., All Rights Reserved
          </p>
