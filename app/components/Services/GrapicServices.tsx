...
const cards = [
  ...
  <path d="M7.07 14.94C5.79 16.2 4 16 4 16s-.2-1.79 1.06-3.07l2.01 1.01z" />
    ...
    title: "Logo Design",
    description: "Unique and professional logos that define your brand identity.",
    color: "#4f46e5",
  },
  {
    icon: (
  ...
  <circle cx="11" cy="11" r="2" />
    ...
    description: "Complete branding solutions including typography and color palettes.",
    color: "#7c3aed",
  },
  {
    icon: (
